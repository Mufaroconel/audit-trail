...
SECRET_KEY = 'django-insecure-_p_t6&n*1i3g+tinksd4e1@ag)&wy@usp_86l2wl73qicyt#_f'
...
MIDDLEWARE = [
    ...
    'predictor.middleware.AuditTrailMiddleware',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'predictor.context_processors.notification_count',
            ],
        },
    },
]
